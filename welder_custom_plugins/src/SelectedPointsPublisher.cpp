...
// {
//     nh_ = std::make_shared<rclcpp::Node>("SelectedPointPublisher");
...
//     rviz_selected_pub_ = nh_->create_publisher<sensor_msgs::msg::PointCloud2>( rviz_cloud_topic_.c_str(), 1 );
//     real_selected_pub_ = nh_->create_publisher<sensor_msgs::msg::PointCloud2>( real_cloud_topic_.c_str(), 1 );
//     partial_pc_pub_ = nh_->create_publisher<sensor_msgs::msg::PointCloud2>( subs_cloud_topic_.c_str(), 1 );
//     // bb_marker_pub_ = nh_->create_publisher<visualization_msgs::Marker>(bb_marker_topic_.c_str(), 1);
//     pc_subs_ =  nh_->create_subscription<sensor_msgs::msg::PointCloud2>(subs_cloud_topic_.c_str(),1,std::bind(&SelectedPointsPublisher::PointCloudsCallback, this, _1));
...
//             //     rviz_common::M_Picked selection = sel_manager->getSelection();
...
//             // }
//             if(event->key() == 'r' || event->key() == 'R') //was elseif
//             {
...
//             //     sensor_msgs::msg::PointCloud2 partial_pc_ros;
...
//     auto view_picker = context_->getViewPicker();
//     Ogre::Vector3 point_rel_world;  // output of get3DPoint().
//     // view_picker->get3DPoint(event.panel,sel_start_x_, sel_start_y_, point_rel_world));
...
//     sensor_msgs::msg::PointCloud2 selected_points_ros;
...
//         ptr += 4;
//     }
//     //selected_points_ros.header.stamp = nh_->get_clock();
...
//     sensor_msgs::msg::PointCloud2 accumulated_segment_ros;
...
// PLUGINLIB_EXPORT_CLASS(welder_panel::SelectedPointsPublisher, rviz_common::Tool)
